...
function EditEmployee() {
    ...
    return (
        <>
            <button onClick={handleShow} className="px-4 py-1 text-sm 
            text-purple-600 font-semibold rounded-full border 
            border-purple-200 
            :text-white hover:bg-purple-600 hover:border-transparent 
            ...
            <Modal show={show} onHide={handleClose} animation={false}>
                    ...
                    <form id='editmodal' className="w-full max-w-sm">
                        <div className="md:flex md:items-center mb-6">
                            ...
                            <div className="md:w-2/3">
                                <input className="bg-gray-200 appearance-none 
                ...
                <Modal.Footer>
                    ...
                    <Button className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-2 rounded" 
                    form="edirmodal">Update</Button>
                </Modal.Footer>
            </Modal>
        </>
    );
